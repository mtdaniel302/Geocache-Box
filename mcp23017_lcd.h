#ifndef MCP23017_LCD_H
#define MCP23017_LCD_H
/*************************************************************************
...
/* Working Functions:
void lcd_init(MCP23017 *obj)			Initialize LCD screen

void lcd_sendcommand(uint8_t data)		Send a command to the LCD

void lcd_gotoxy(uint8_t x, uint8_t y)	Set cursor at coordinate (x,y) (x=0-15, y=0-1)

void lcd_clrscr(void)					clear the screen

void lcd_home(void)						Set cursor to home position

void lcd_putc(char data)				Write a character to the screen, auto increment cursor

void lcd_puts(const char *s)			write string to screen from RAM, null terminated

void lcd_puts_p(const char *progmem_s)	write string to screen from program memory
...
*change lcd color:
* 1=input, 0 = output
* reg 0x00, data 0x3F //set to output, bit 7 is green, bit 6 is red
* reg 0x01, data 0xFE //set to output, bit 0 is blue
* low is on, high is off
* reg 0x12, data 0x80 //green off, red on
* reg 0x12, data 0x40 //red off, green on
* reg 0x12, data 0xC0 //both red and green off
* reg 0x12, data 0x00 //both red and green on
* reg 0x13, data 0x00 //blue on
* reg 0x13, data 0x01 //blue off
*/
...
#define LCD_DELAY_BOOTUP   100000      /**< delay in micro seconds after power-on  16000 */
#endif
...
/**
 @brief    Sends 8-bit command over I2C I/O expander to LCD via nibbles
 @return   none
*/
void lcd_sendcommand(uint8_t data);

/**
 @brief    Sends 8-bit character over I2C I/O expander to LCD via nibbles
 @return   none
*/
...
/**
 ...
 @return  none
*/
extern void lcd_init(MCP23017 *obj);
